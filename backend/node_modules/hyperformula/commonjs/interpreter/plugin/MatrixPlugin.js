  ...
  _createClass(MatrixPlugin, [{
    ...
    value: function maxpoolArraySize(ast, state) {
      ...
      var subChecks = ast.args.map(function (arg) {
        ...
        return _this5.arraySizeForAst(arg, new _InterpreterState.InterpreterState(state.formulaAddress, state.arraysFlag || ((_a = metadata === null || metadata === void 0 ? void 0 : metadata.arrayFunction) !== null && _a !== void 0 ? _a : false)));
      });
