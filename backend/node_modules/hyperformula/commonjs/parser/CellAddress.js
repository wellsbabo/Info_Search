...
var CellAddress = /*#__PURE__*/function () {
  ...
  _createClass(CellAddress, [{
    ...
    value: function toColumnAddress() {
      var refType = this.isColumnRelative() ? _ColumnAddress.ReferenceType.RELATIVE : _ColumnAddress.ReferenceType.ABSOLUTE;
      return new _ColumnAddress.ColumnAddress(refType, this.col, this.sheet);
    }
  }, {
    key: "toRowAddress",
    value: function toRowAddress() {
      var refType = this.isRowRelative() ? _ColumnAddress.ReferenceType.RELATIVE : _ColumnAddress.ReferenceType.ABSOLUTE;
