...
var FormulaParser = /*#__PURE__*/function (_EmbeddedActionsParse) {
  ...
  _createClass(FormulaParser, [{
    ...
    value: function orderCellRangeEnds(endA, endB) {
      ...
      }).sort(_ColumnAddress.ColumnAddress.compareByAbsoluteAddress(this.formulaAddress)),
          _ends$map$sort2 = _slicedToArray(_ends$map$sort, 2),
          startCol = _ends$map$sort2[0],
          endCol = _ends$map$sort2[1];

      var _ends$map$sort3 = ends.map(function (e) {
        return e.toRowAddress();
      }).sort(_RowAddress.RowAddress.compareByAbsoluteAddress(this.formulaAddress)),
          _ends$map$sort4 = _slicedToArray(_ends$map$sort3, 2),
      ...
      var _ends$map$sort5 = ends.map(function (e) {
        return e.sheet;
          ...
          _ends$map$sort6 = _slicedToArray(_ends$map$sort5, 2),
    ...
    value: function orderColumnRangeEnds(endA, endB) {
      ...
      var _ends$sort = ends.sort(_ColumnAddress.ColumnAddress.compareByAbsoluteAddress(this.formulaAddress)),
          _ends$sort2 = _slicedToArray(_ends$sort, 2),
      ...
      var _ends$map$sort7 = ends.map(function (e) {
        return e.sheet;
          ...
          _ends$map$sort8 = _slicedToArray(_ends$map$sort7, 2),
    ...
    value: function orderRowRangeEnds(endA, endB) {
      ...
      var _ends$sort3 = ends.sort(_RowAddress.RowAddress.compareByAbsoluteAddress(this.formulaAddress)),
          _ends$sort4 = _slicedToArray(_ends$sort3, 2),
      ...
      var _ends$map$sort9 = ends.map(function (e) {
        return e.sheet;
          ...
          _ends$map$sort10 = _slicedToArray(_ends$map$sort9, 2),
  ...
  _createClass(FormulaLexer, [{
    ...
    value: function skipWhitespacesInsideRanges(tokens) {
      ...
      return FormulaLexer.filterTokensByNeighbors(tokens, function (previous, current, next) {
        return ((0, _chevrotain.tokenMatcher)(previous, _LexerConfig.CellReference) || (0, _chevrotain.tokenMatcher)(previous, _LexerConfig.RangeSeparator)) && (0, _chevrotain.tokenMatcher)(current, _this2.lexerConfig.WhiteSpace) && ((0, _chevrotain.tokenMatcher)(next, _LexerConfig.CellReference) || (0, _chevrotain.tokenMatcher)(next, _LexerConfig.RangeSeparator));
      });
    }
  }, {
    ...
    value: function skipWhitespacesBeforeArgSeparators(tokens) {
      ...
      return FormulaLexer.filterTokensByNeighbors(tokens, function (previous, current, next) {
        return !(0, _chevrotain.tokenMatcher)(previous, _this3.lexerConfig.ArgSeparator) && (0, _chevrotain.tokenMatcher)(current, _this3.lexerConfig.WhiteSpace) && (0, _chevrotain.tokenMatcher)(next, _this3.lexerConfig.ArgSeparator);
      });
    }
  }, {
